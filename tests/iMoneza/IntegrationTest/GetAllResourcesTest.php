<?php
/**
 * Tests getting the resources for a property
 *
 * @author Aaron Saray
 */
...
class GetAllResourcesTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testGetResourceFromResourceKey()
    {
        ...
        $this->assertInstanceOf('\iMoneza\Data\ResourceCollection', $result);
